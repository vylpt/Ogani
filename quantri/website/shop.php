                            ...
                            <div class="latest-product__text">
                                ...
                                <div class="latest-product__slider owl-carousel">
                                    ...
                                    <a href="sanpham.php?id=<?=$row['id']?>" class="latest-product__item">
                                            <div class="latest-product__item__pic" style="width: 110px; aspect-ratio: 1/1;">
                                                <img src="<?= "quantri/".$anh_arr[0]?>" alt="" style="object-fit: cover;">
                                            </div>
                                            <div class="latest-product__item__text">
                                                <h6><?= $row['name']?></h6>
                                                <span><?= $row['disscounted_price']?></span>
                                    ...
                                    <div class="latest-prdouct__slider__item">
                                    <?php
                                             $sql_str = "SELECT * FROM `products` ORDER BY created_at DESC LIMIT 9, 6";
                                             $result = mysqli_query($conn, $sql_str);
                                                  while ($row = mysqli_fetch_assoc($result)){
                                                    $anh_arr = explode(';', $row['images']);
                                        ?>    
                                    ...
                                    <div class="latest-prdouct__slider__item">
                                    <?php
                                             $sql_str = "SELECT * FROM `products` ORDER BY created_at DESC LIMIT 12, 9";
                                             $result = mysqli_query($conn, $sql_str);
                                                  while ($row = mysqli_fetch_assoc($result)){
                                                    $anh_arr = explode(';', $row['images']);
                                        ?>    

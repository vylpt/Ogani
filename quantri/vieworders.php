                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="p-5">
                            ...
                            <div class="row">
                                <div class="col-md-6"> <form class="user" method="post" action="#" > 
                                <div class="row">
                                ...
                                <a class="btn btn-danger" 
                                                href="deleteview.php?id=<?=$row['id']?>"
                                                onclick="return confirm('Bạn có chắc chắn xoá mục này không?');">Delete</a>
                            </form></div>
                                <div class="col-md-6">
...
while ($row = mysqli_fetch_assoc($res)) {
   $tongtien += $row['qty'] * $row['oprice'];
                                    ...
                                    <tr>
                                        <td><?=++$stt?></td>
                                        <td><?=$row['pname']?></td>
                                        <td><?=number_format($row['oprice'],0,'','.') . " VND"?></td>
                                        <td><?=$row['qty']?></td>
                                    ...
                                    <div class="tongtien">
                                        Tổng tiền: <h5><?=number_format($tongtien,0,'','.') . " VND"?></h5>
                                    </div>
                                </div>
                            </div>
